...
public class EntityYellowWither extends EntityCustomWither{
	
	public EntityYellowWither(World world, Location spawnpoint, Team team) {
		super(world);
		
        this.setCustomName(ChatColor.YELLOW + "Yellow Wither");
