...
public class EntityRedWither extends EntityCustomWither{
	
	public EntityRedWither(World world, Location spawnpoint, Team team) {
		super(world);
		
        this.setCustomName(ChatColor.RED + "Red Wither");
