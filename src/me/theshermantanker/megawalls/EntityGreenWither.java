...
public class EntityGreenWither extends EntityCustomWither{
	
	public EntityGreenWither(World world, Location spawnpoint, Team team) {
		super(world);
        this.setCustomName(ChatColor.GREEN + "Green Wither");
